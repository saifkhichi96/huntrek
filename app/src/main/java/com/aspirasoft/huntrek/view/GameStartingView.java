...
public class GameStartingView extends RelativeLayout {

    private ImageView coverImage;
    private TextView messageView;
    private AnnotatedProgressBar annotatedProgressBar;
    ...
    public GameStartingView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public GameStartingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public GameStartingView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void start() {
        annotatedProgressBar.start(getContext());
